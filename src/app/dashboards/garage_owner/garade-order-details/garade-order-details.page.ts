...
@Component({
  selector: 'app-garade-order-details',
  templateUrl: './garade-order-details.page.html',
  styleUrls: ['./garade-order-details.page.scss'],
})
export class GaradeOrderDetailsPage implements OnInit {
