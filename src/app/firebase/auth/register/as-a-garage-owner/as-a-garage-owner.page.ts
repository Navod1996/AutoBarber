...
@Component({
  selector: 'app-as-a-garage-owner',
  templateUrl: './as-a-garage-owner.page.html',
  styleUrls: ['./as-a-garage-owner.page.scss'],
})
export class AsAGarageOwnerPage implements OnInit {
